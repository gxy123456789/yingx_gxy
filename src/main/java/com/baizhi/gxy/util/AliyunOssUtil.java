...
public class AliyunOssUtil {
    ...
    private static String accessKeyId = "LTAI4FqcFRX15KLk17Sux2gP";
    private static String accessKeySecret = "TzsCdRDD9L9Vmtm4PN489becPqbI1f";
    private static String bucket="yingxapp";
