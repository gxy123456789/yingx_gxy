...
<script>
    ...
    function pageInit(){
        //父表格
        $("#cateTable").jqGrid({
            url:"${path}/category/showAllcategory",
        ...
        //父表格分页工具栏
        $("#cateTable").jqGrid('navGrid', '#catePage', {add : true,edit : true,del : true},{closeAfterEdit:true},{closeAfterAdd:true},{
            closeAfterdel:true,
    ...
    function addSubGrid(subgridId, rowId){
        ...
        $("#" + subgridTableId).jqGrid({
            url:"${path}/category/queryBuPagerTwo?parent_id="+rowId,
            ...
            colModel : [
                ...
                {name : 'cate_name',editable:true,index : 'invdate',width : 90},
                {name : 'levels',index : 'name',width : 100},
                {name : 'parent_id',index : 'name',width : 100}
            ]
        });

        //子表格分页工具栏
        $("#" + subgridTableId).jqGrid('navGrid',"#" + pagerId, {edit : true,add : true,del : true},{closeAfterEdit:true},{closeAfterAdd:true},{
            closeAfterdel:true,
                afterSubmit:function (response) {
                    //向警告框中写入内容
                    $("#showMsg").html(response.responseJSON.message);
