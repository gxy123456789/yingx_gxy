            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true" align="center">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><button class="btn btn-info" ><a href="javascript:$('#MainId').load('${path}/main/Goeasy.jsp')">用户统计</a></button><br><br></li>
                ...
                <div class="panel panel-success">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                        <div class="panel-body">
                            <ul class="nav nav-pills nav-stacked">
                                <li><button class="btn btn-success" ><a href="javascript:$('#MainId').load('${path}/category/category.jsp')">分类展示</a></button><br><br></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div class="panel panel-footer" align="center">
    <div>@百知教育 guxinyi@zparkhr.com</div>
</div>
